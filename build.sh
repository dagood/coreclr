...
usage()
{
    echo "Usage: $0 [BuildArch] [BuildType] [verbose] [coverage] [cross] [clangx.y] [ninja] [configureonly] [skipconfigure] [skipnative] [skipmscorlib] [skiptests] [nostripsymbols] [cmakeargs] [bindir]"
    ...
    echo "noStripSymbols - Optional argument to ensure symbols are not stripped."
...
while :; do
    ...
    case $lowerI in
        ...
        nostripsymbols)
            __cmakeargs="$__cmakeargs -DNO_STRIP_SYMBOLS=true"
            ;;
